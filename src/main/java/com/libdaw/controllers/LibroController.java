...
public class LibroController extends HttpServlet {
    ...
    private void listLibros(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("views/list-libro.jsp");
    ...
    private void showNewForm(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        RequestDispatcher dispatcher = request.getRequestDispatcher("views/form-libro.jsp");
        dispatcher.forward(request, response);
    }

    private void editLibro(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        int idLibro = Integer.parseInt(request.getParameter("id"));
        Libro libros = null;
        try {
            libros = libroDao.GetLibroById(idLibro);
        } catch (SQLException e) {
            e.printStackTrace();
        }
